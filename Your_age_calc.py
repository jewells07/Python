...
# print(length)
try:
    if int(input1) > 1919 and int(input1) < 2019 and length == 4:
        print(f"You will be 100 at {int(input1) + 100}")
    elif int(input1) < 99 and int(input1) >14 and length == 2:
        print(f"You will be 100 at year{(2019 - int(input1)) + 100} ")
    elif (int(input1) < 1919 and int(input1) > 99 ) or (length == 4 or length == 2):
